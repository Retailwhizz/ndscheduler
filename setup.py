...
setup(
    name=PACKAGE,
    version=__version__,
    description='mdmscheduler: A cron-replacement library from Retailio',
    long_description=open('README.md').read(),
    author='Aibin Varghese',
    author_email='aibin@retailwhizz.com',
    url='https://github.com/Retailwhizz/mdm-scheduler',
    download_url='http://pypi.python.org/pypi/mdmscheduler#downloads',
    license='Apache License, Version 2',
    keywords='scheduler mdm cron python',
