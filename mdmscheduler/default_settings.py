...
# See different database providers in mdmscheduler/core/datastore/providers/

# SQLite
#
DATABASE_CLASS = 'mdmscheduler.core.datastore.providers.sqlite.DatastoreSqlite'
...
# Postgres
#
# DATABASE_CLASS = 'mdmscheduler.core.datastore.providers.postgresql.DatastorePostgresql'
# DATABASE_CONFIG_DICT = {
#     'user': 'username',
#     'password': '',
#     'hostname': 'localhost',
...
# MySQL
#
# DATABASE_CLASS = 'mdmscheduler.core.datastore.providers.mysql.DatastoreMysql'
# DATABASE_CONFIG_DICT = {
#     'user': 'username',
#     'password': '',
#     'hostname': 'localhost',
...
# Please see mdmscheduler/core/scheduler/base.py
SCHEDULER_CLASS = 'mdmscheduler.core.scheduler.base.SingletonScheduler'
