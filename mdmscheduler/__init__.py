...
from mdmscheduler import default_settings
...
def setup_package():
    ...
    os.environ[ENVIRONMENT_VARIABLE] = 'mdmscheduler.default_settings_test'
...
class Settings(object):
    """Singleton class to manage mdmscheduler settings."""
